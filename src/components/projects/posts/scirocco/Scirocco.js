      ...
      <div className="w-full flex flex-col justify-center items -center text-center p-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4  justify-center items-center">
          <p className="p-8 text-xl">
            <ul>
              <h3 className="font-titleFont text-2xl"> Восстановление:</h3>
              <li>- Ремонт крыла;</li>
          ...
          <p className="p-8 text-xl">
            <ul>
              ...
              <li>- Новый байпас;</li>
              <li>- Новые подшипники;</li>
              <li>- Новый маслоуловитель;</li>
              <li>- Новая цепь;</li>
              <li>Замены сальника двс;</li>
              <li>- Новые лопатки фазорегулятора;</li>
              <li>- Новый сам клапан фазорегулятора;</li>
              <li>- Новые задние колодки;</li>
              <li>- Новый радиатор;</li>
              <li>- Новые свечи</li>
            </ul>
          </p>
          ...
          <p className="p-8 text-xl">
            <ul>
              ...
              <li>
                - Перешитые передние сиденья в натуральную алькантару с
                элементами кожи;
              </li>
              <li>- Ремни в цвет салона;</li>
              <li>- Пластик салона окрашен в черный глянец ;</li>
              <li>- Дверные обшивки в алькантаре цвета антрацит ;</li>
              <li>- Камера заднего вида;</li>
              <li>- Магнитола на Android с сим картой;</li>
              <li>
                - Замена линз на biLed, новые стекла, маски окрашены в черный
                глянец;
              </li>
