      ...
      <div className="w-full flex flex-col justify-center items -center text-center p-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4  justify-center items-center">
          <p className="p-8 text-xl">
            <ul>
              <h3 className="font-titleFont text-2xl"> Экстерьер</h3>
              <li>- Изготовление переднего бампера под расширение;</li>
              <li>
                - Изготовление заднего бампера со сращиванием с элементами
                Toyota GT86;
              </li>
      ...
      <div className="w-full flex flex-col justify-center items -center text-center p-8">
        <div className="flex flex-row justify-between">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4  justify-center items-center">
            ...
            <p className="p-8 text-xl">
              <ul>
                <h3 className="font-titleFont text-2xl"> Интерьер</h3>
                <li>
                  Полный перешив салона в родной цвет с перфорацией и
                  воссозданием заводской вышивки
                </li>
              </ul>
            </p>
            <p className="p-8 text-xl">
