...
const Mbclassicextremeblack = () => {
  return (
    <div className="bg-navbarColor">
      ...
      <div className="grid grid-cols-2 gap-4 justify-center items-center">
        <p className="p-8 text-xl">
        3D сканирование и макетирование
Изготовление расширителей кузова
Лифт подвески
35-ти дюймовые колеса для повышения проходимости
Оружейные сейфы
Выдвижные пороги
Крышка кузова с электрическими приводами
        </p>
        {/* <img src={img2} alt="2" /> */}
         </div>
...
<li>Установка лебедки с дистанционным управлением
CUSTOM задних светодиодных фонарей </li>
<li>Изготовление заднего бампера с инсталлированными в него насадками выпускной системы</li>
<li>Установка дополнительного света от компании RIGID с модулями управления режимами дальнего\ближнего света и подсветки</li>
Также инсталляция в бампер модульных ПТФ от компании RIGID.
      ...
      <div className="grid grid-cols-2 gap-4 justify-center items-center"> 
      {/* <img src={img5} alt="5" /> */}
      <h3 className="font-titleFont text-2xl">ДОПОЛНИТЕЛЬНЫЕ БЛОКИ И ОБОРУДОВАНИЕ</h3>
        <p className="p-8 text-xl">
       <li>Прошивка блока управления двигателем и АКПП с повышением мощности и снятием ограничений</li> 
       <li>Инвертор 12 вольт в 220 вольт на 4000 ватт</li>
<li>2 оружейных сейфа, инсталлированные в борта кузова с электроприводами</li>
<li>Спортивный выхлоп из нержавеющей стали с регулировкой громкости
Выдвижной фаркоп</li>
...
<li>Монтаж пульта управления электропривода сидений в дверные карты</li>
