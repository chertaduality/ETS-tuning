    ...
    <div className="bg-navbarColor">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 justify-center items-center">
          ...
          <p className="p-8 text-xl">
            <h3 className="font-titleFont text-2xl">
              Проект был создан по заказу крупного автохолдинга АВТОДОМ по
              образцу концепт-кара Mercedes-Benz X-class
            </h3>
          </p>{' '}
        </div>
      </div>
      ...
      <div className="w-full flex flex-col justify-center items -center text-center p-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 justify-center items-center">
          ...
          <p className="p-8 text-xl">
            FACELIFT осущетсвлен при помощи 3D макетирования и инсталляции
            оптики Mercedes-Benz CLA.
          </p>
        </div>
      </div>
      <div className="w-full flex flex-col justify-center items -center text-center p-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 justify-center items-center">
          ...
          <img src={img6} alt="6" /> <img src={img7} alt="7" />
          <img src={img8} alt="8" />
        </div>
      </div>
      <div className="w-full flex flex-col justify-center items -center text-center p-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 justify-center items-center">
          <p className="p-8 text-xl">
            ...
            система изготовлена из нержавеющей стали с регулировкой громкости.
          </p>
          <img className="w-full" src={img9} alt="9" />
        </div>
        <p className="p-8 text-xl">
          Внесение индивидуальных решений по отделке салона с использованием
          натуральной кожи и шпона из эбенового дерева.
        </p>
        <p className="p-8 text-xl">
          Детали интерьера декорированы с использованием материала ALCANTARA.
        </p>
        <p className="p-8 text-xl">
