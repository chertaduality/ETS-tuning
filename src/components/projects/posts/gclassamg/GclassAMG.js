...
const GclassAMG = () => {
  return (
    <div className="bg-navbarColor">
      ...
      <div className="grid grid-cols-2 gap-4 justify-center items-center"> 
        <p className="p-8 text-xl">
          Установлена световая балка RIGID и задние дополнительные сигналы. Фары
          под заказ, изготовлены в США. Диодные дневные ходовые огни.
        </p><img className="w-full" src={img1} alt="1" /></div>
      ...
      <div className="grid grid-cols-2 gap-4 justify-center items-center">  
        <p className="p-8 text-xl">
          Кастомные усиленные пружины с лифтом под массу авто. Амортизаторы Fox
          с выносным бачком. Тюнинг тормозной системы.
        </p><img className="w-full" src={img3} alt="3" /></div>
      ...
      <div className="grid grid-cols-2 gap-4 justify-center items-center"> 
        ...
        <img className="w-[50%] mt-4" src={img7} alt="7" /></div>
      </div>
    </div>
  );
};
