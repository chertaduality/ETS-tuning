    ...
    <div className="mt-36 bg-white">
      <div className="w-full flex flex-col justify-center items -center text-center p-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-16 justify-center items-center">
          ...
          <p className="p-8 text-xl">
          3D сканирование - это процесс анализа объекта реального мира или окружающей среды для сбора трехмерных данных о его форме и, возможно, внешнем виде (например, цвет). Собранные данные затем могут быть использованы для построения цифровых 3D-моделей.
          </p>
        </div>
